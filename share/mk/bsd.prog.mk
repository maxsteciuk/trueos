...
_proginstall:
.if defined(PROG)
	${INSTALL} -F ${TAG_ARGS} ${STRIP} -o ${BINOWN} -g ${BINGRP} -m ${BINMODE} \
	    ${_INSTALLFLAGS} ${PROG} ${DESTDIR}${BINDIR}/${PROGNAME}
.if ${MK_DEBUG_FILES} != "no"
	${INSTALL} -F ${TAG_ARGS:D${TAG_ARGS},debug} -o ${BINOWN} -g ${BINGRP} -m ${DEBUGMODE} \
...
_SCRIPTSINS_${script:T}: ${script}
	${INSTALL} -F ${TAG_ARGS} -o ${SCRIPTSOWN_${.ALLSRC:T}} \
